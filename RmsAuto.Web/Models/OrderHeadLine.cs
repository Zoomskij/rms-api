...
namespace RMSAutoAPI.Models
{
    public class OrderHeadLine : Part
    {
        ...
        [Description("Реакция на коллизию по количеству:" +
			...
			"\n1 - размещаем столько, сколько есть в остатках, но не больше указанного в поле Count кол-ва" +
			"\n2 - как и в случае с 1, но при несоответствии по кратности разрешаем выравнивание вверх по кратности (МinOrderQty объекта SparePart)" +
			"\n3 - как и в случае с 1, но при несоответствии по кратности разрешаем выравнивание вниз по кратности (МinOrderQty объекта SparePart)")]
